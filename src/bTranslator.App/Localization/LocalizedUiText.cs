...
public sealed class LocalizedUiText : ObservableObject
{
    ...
    private static readonly IReadOnlyDictionary<string, (string ResourceKey, string Fallback)> ResourceMap =
        new Dictionary<string, (string ResourceKey, string Fallback)>(StringComparer.Ordinal)
        {
            ...
            [nameof(MenuChain)] = ("Menu.Chain", "Model"),
            ...
            [nameof(MenuCompatibilityModes)] = ("Menu.CompatibilityModes", "Compatibility Modes"),
            [nameof(MenuCompatibilityPexMode)] = ("Menu.CompatibilityPexMode", "PEX Mode"),
            [nameof(MenuOpenPexMode)] = ("Menu.OpenPexMode", "Open PEX Mode..."),
            [nameof(MenuExportPexStrings)] = ("Menu.ExportPexStrings", "Export PEX Strings..."),
            [nameof(MenuCompatibilityMcmMode)] = ("Menu.CompatibilityMcmMode", "MCM/XML Mode"),
            [nameof(MenuOpenMcmMode)] = ("Menu.OpenMcmMode", "Open MCM/XML Mode..."),
            [nameof(MenuExportMcmMode)] = ("Menu.ExportMcmMode", "Export MCM/XML..."),
            [nameof(MenuCompatibilityTxtMode)] = ("Menu.CompatibilityTxtMode", "TXT/SST Mode"),
            [nameof(MenuOpenTxtMode)] = ("Menu.OpenTxtMode", "Open TXT/SST Mode..."),
            [nameof(MenuExportTxtMode)] = ("Menu.ExportTxtMode", "Export TXT/SST..."),
            [nameof(MenuRunTxtBatchScript)] = ("Menu.RunTxtBatchScript", "Run TXT Batch Script..."),
            ...
            [nameof(AiCopilotSectionTitleText)] = ("AiCopilotSectionTitle.Text", "AI Copilot"),
            [nameof(AiCopilotProviderChainHeaderText)] = ("AiCopilotProviderChainHeader.Text", "Model"),
            [nameof(AiCopilotMcpHintText)] = ("AiCopilotMcpHint.Text", "Tip: /mcp translate-mod --save to localize and save quickly."),
            [nameof(AiCopilotInputBoxPlaceholderText)] = ("AiCopilotInputBox.PlaceholderText", "Ask for translation help or run /mcp commands..."),
    ...
    public string MenuCompatibilityModes => Get();
    public string MenuCompatibilityPexMode => Get();
    public string MenuOpenPexMode => Get();
    public string MenuExportPexStrings => Get();
    public string MenuCompatibilityMcmMode => Get();
    public string MenuOpenMcmMode => Get();
    public string MenuExportMcmMode => Get();
    public string MenuCompatibilityTxtMode => Get();
    public string MenuOpenTxtMode => Get();
    public string MenuExportTxtMode => Get();
    public string MenuRunTxtBatchScript => Get();
    ...
    public string AiCopilotSectionTitleText => Get();
    public string AiCopilotProviderChainHeaderText => Get();
    public string AiCopilotMcpHintText => Get();
    public string AiCopilotInputBoxPlaceholderText => Get();
